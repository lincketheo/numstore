...
void bnode_key_value_print (FILE *ofp, bnode_key_value *b);
...
void bnode_append_key_value (bnode *dest, const bnode *src, child_ptr_t ptr,
                             bnode_key_value k);

void bnode_print (FILE *ofp, bnode *b);
